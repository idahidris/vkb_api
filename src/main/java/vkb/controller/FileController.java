...
import vkb.dto.UploadFileResponse;
import vkb.service.impl.FileStorageService;
...
public class FileController extends ApiController {
    ...
    @PostMapping(value = "/uploadFile", headers = ("content-Type=multipart/*"), consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
